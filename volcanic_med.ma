...
%zone : pxy			{ (0,0,6)..(8,19,6) }
zone : qxy			{ (0,0,4)..(8,19,5) }
zone : move_x		{ (0,0,1)..(8,19,1) }
zone : move_y		{ (0,0,2)..(8,19,2) }
zone : move_xy		{ (0,0,3)..(8,19,3) }
zone : Ni			{ (0,0,0)..(8,19,0) }
zone : ground		{ (9,0,0)..(9,19,0) }
